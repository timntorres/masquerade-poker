...
class History:
    ...
    # Players
    # List of events 
    # Timestamp of each action / event
    def __init__():
        now = datetime.now()
        timestamp = now.strftime("%Y-%m-%d  %H-%M-%S")

class Pot:
    def __init__(self, amount, players, parent_pot=None):
        self.amount = amount
...
class TexasHoldEm:
    ...
    def start_round(self, game_log="", round_number=0):
        self.pot = Pot(0, self.players, None)
